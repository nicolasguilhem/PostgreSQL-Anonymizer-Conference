...
Mais il y en a un qui devrait être considéré en premier : l'article 25 : « protection des données dès la conception » et « sécurité par défaut » (Privacy by design).
--
...
--
1999 : Ann Cavoukian en formalise les principes fondamentaux
2005 : Adaptation en se basant sur les 7 lois de l'identité de Kim Cameron.
--
...
- Renforcement et précision du Privacy by Design (notamment dans les contextes IoT et IA).
--
...
- La question n'est plus "si mes données on fuitées ou quand mes données ont fuitées mais quand mes données seront exploitées"
--
